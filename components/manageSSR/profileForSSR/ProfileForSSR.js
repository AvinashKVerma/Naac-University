...
import Basic_Information from "./Basic_Information/BasicInformation";
import AcademicInformation from "./AccademicInformation/AcademicInformation";
...
const ProfileForSSR = () => {
  ...
  const buttonContent = {
    "Basic Information": (
      <div>
        <Basic_Information setActiveButton={setActiveButton} />
      </div>
    ),
    "Academic Information": (
      <div>
        <AcademicInformation setActiveButton={setActiveButton} />
      </div>
    ),
